...
#################################################################
####                                                         ####
####            PROJECT AUTHORS : VISHAL KULKARNI            ####
####                                                         ####
#################################################################
#################################################################
...
def readfile(x):
    ...
    try:
        ...
        print ("#" * 104)
        print(
        "###### Improper Syntax: try - python3 SNP_FinalProject.py traindata trainlabels testdata {i.e. 3 dataset files} #####")
        print ("#" * 104)
        sys.exit()
    ...
    def calFetures(data, labels):
        ...
        linearSVC = LinearSVC(C=0.0024, penalty='l1', dual=False).fit(data, [x[0] for x in
                                                                             labels])  # HERE CHANGE THE VALUE OF C FROM 0.002 TO 0.0021 OR 0.0024 OR 0.003 OR MORE TO GET MORE FEATURES {MORE ACCURACY}...(:D)
    ...
    def getFetures(testdata, feature_cols):
        ...
        bestfeaturestestdata_file = open(
            '/Users/vishalkulkarni/Developments/Project_MachineLearning/bestfeaturestestdata', 'w')
    ...
    def main():
        ...
        for x in range(20):
            cnt += 1
            if (x == 0):
                org_data, org_labels, data, labels, predictdata, predictlabels = createTrainlabel(bestfeatures_data,
                                                                                                  trainlabels)
            else:
            ...
            predictions.append(
                balance_error("/Users/vishalkulkarni/Developments/Project_MachineLearning/datasets/trueclass.txt",
                              "/Users/vishalkulkarni/Developments/Project_MachineLearning/predictedlabels"))
